...
if (chmod($archivoBashDestino, 0755) === false) {
    echo "Error al otorgar permisos de ejecución al archivo bash.";
    return;
}
...
if ($file === false) {
    echo "Error al descargar el archivo .jar.";
    return;
}
...
if (file_put_contents($archivoJarDestino, $file) === false) {
    echo "Error al guardar el archivo .jar.";
    return;
}
